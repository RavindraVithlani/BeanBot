        ...
        <View style={styles.modalView}>
          <View style={styles.contentContainer}>
            ...
            <View style={styles.buttonContainer}>
              <TouchableOpacity style={styles.button} onPress={router.push(`/class/${data.classname}`)}>
                <Text style={styles.buttonText}>Read More</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.button} onPress={router.push(`/class/${data.classname}/names`)}>
